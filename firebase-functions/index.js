        ...
        try {
            ...
            const payload = {
                ...
                data: {
                    ...
                    ...(notification.metadata?.postId && { postId: notification.metadata.postId }),
                    ...(notification.metadata?.conversationId && { conversationId: notification.metadata.conversationId }),
                    ...(notification.metadata?.commentId && { commentId: notification.metadata.commentId })
                },
                token: fcmToken
            };
